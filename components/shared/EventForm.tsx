...
const EventForm = ({userId, type, event, eventId}: EventFormProps) => {
    ...
    return (
        <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 focus:main-fill-border">
            ...
            <div className="flex flex-col gap-5 md:flex-row">
                <FormField
                    ...
                    render={({ field }) => (
                        ...
                        <Textarea placeholder="Describe your event" {...field} className="textarea rounded-2xl" />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
                                ...
                                <FormField
                                        ...
                                        render={({ field }) => (
                                            ...
                                            <FormControl>
                                                ...
                                                checked={field.value}
                                                 id="isFree" 
                                                 className="mr-2 h-5 w-5 border-2 border-red-500 data-[state=checked]:bg-red-500"/>
                                                </div>
                                            </FormControl>
                                            <FormMessage />
                                            </FormItem>
          ...
          >{form.formState.isSubmitting ? ('Submitting...'): (`${type}`)}</Button>
        </form>
      </Form>
  )
}
